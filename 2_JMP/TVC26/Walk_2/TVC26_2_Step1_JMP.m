...
fprintf('============================================================\n');
fprintf('NMSM JMP RUNNER  v6  TVC26 Walk_2  (v5 full body - stroke config, 8 steps, redistributed budget)\n');
fprintf('Started: %s\n', datestr(now));
fprintf('============================================================\n');
...
fprintf('Next: run TVC26_2_Step2_STO_PLOTS.m\n');
