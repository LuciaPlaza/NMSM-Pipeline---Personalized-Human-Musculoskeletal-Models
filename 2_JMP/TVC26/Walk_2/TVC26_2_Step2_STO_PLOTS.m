...
% (TVC26_scaled.osim) and the final personalised model (after the LAST
...
% OUTPUTS
% -------
%  TVC26_2_JMP_results/TVC26_2_STO_and_Plots_ONLY/
...
baseFolder = 'C:\Users\lucia\Desktop\TFG\2_JMP\TVC26\Walk_2';

settingsFiles = {
    fullfile(baseFolder, 'TVC26_2_JMP_01_pelvis_thigh_marker_adjustment.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_02_knee_ankle_joint_personalization.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_03_lower_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_04_ankle_axis_personalization.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_05_torso_marker_adjustment.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_06_shoulder_elbow_joint_personalization.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_07_upper_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'TVC26_2_JMP_08_wrist_axis_personalization.xml')
};

resultsFolder  = fullfile(baseFolder, 'TVC26_2_JMP_results');
analysisFolder = fullfile(resultsFolder, 'TVC26_2_STO_and_Plots_ONLY');
...
scaledModel = fullfile(baseFolder, 'TVC26_scaled.osim');
