...
fprintf('============================================================\n');
fprintf('NMSM JMP RUNNER  v6  SUBJ59 Walk_1  (v5 full body - stroke config, 8 steps, redistributed budget)\n');
fprintf('Started: %s\n', datestr(now));
fprintf('============================================================\n');
...
fprintf('Next: run SUBJ59_1_Step2_STO_PLOTS.m\n');
