...
% (SUBJ94_scaled.osim) and the final personalised model (after the LAST
...
% OUTPUTS
% -------
%  SUBJ94_3_JMP_results/SUBJ94_3_STO_and_Plots_ONLY/
...
baseFolder = 'C:\Users\lucia\Desktop\TFG\2_JMP\SUBJ94\Walk_3';

settingsFiles = {
    fullfile(baseFolder, 'SUBJ94_3_JMP_01_pelvis_thigh_marker_adjustment.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_02_knee_ankle_joint_personalization.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_03_lower_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_04_ankle_axis_personalization.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_05_torso_marker_adjustment.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_06_shoulder_elbow_joint_personalization.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_07_upper_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'SUBJ94_3_JMP_08_wrist_axis_personalization.xml')
};

resultsFolder  = fullfile(baseFolder, 'SUBJ94_3_JMP_results');
analysisFolder = fullfile(resultsFolder, 'SUBJ94_3_STO_and_Plots_ONLY');
...
scaledModel = fullfile(baseFolder, 'SUBJ94_scaled.osim');
