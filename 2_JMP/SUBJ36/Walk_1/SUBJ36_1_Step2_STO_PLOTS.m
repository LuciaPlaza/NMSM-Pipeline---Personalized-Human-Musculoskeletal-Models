...
% (SUBJ36_scaled.osim) and the final personalised model (after the LAST
...
% OUTPUTS
% -------
%  SUBJ36_1_JMP_results/SUBJ36_1_STO_and_Plots_ONLY/
...
analysisFolder = fullfile(resultsFolder, 'SUBJ36_1_STO_and_Plots_ONLY');
...
scaledModel = fullfile(baseFolder, 'SUBJ36_scaled.osim');
