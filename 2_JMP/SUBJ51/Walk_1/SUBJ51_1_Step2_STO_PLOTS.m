...
% (SUBJ51_scaled.osim) and the final personalised model (after the LAST
...
% OUTPUTS
% -------
%  SUBJ51_1_JMP_results/SUBJ51_1_STO_and_Plots_ONLY/
...
baseFolder = 'C:\Users\lucia\Desktop\TFG\2_JMP\SUBJ51\Walk_1';

settingsFiles = {
    fullfile(baseFolder, 'SUBJ51_1_JMP_01_pelvis_thigh_marker_adjustment.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_02_knee_ankle_joint_personalization.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_03_lower_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_04_ankle_axis_personalization.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_05_torso_marker_adjustment.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_06_shoulder_elbow_joint_personalization.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_07_upper_limb_body_marker_personalization.xml')
    fullfile(baseFolder, 'SUBJ51_1_JMP_08_wrist_axis_personalization.xml')
};

resultsFolder  = fullfile(baseFolder, 'SUBJ51_1_JMP_results');
analysisFolder = fullfile(resultsFolder, 'SUBJ51_1_STO_and_Plots_ONLY');
...
scaledModel = fullfile(baseFolder, 'SUBJ51_scaled.osim');
