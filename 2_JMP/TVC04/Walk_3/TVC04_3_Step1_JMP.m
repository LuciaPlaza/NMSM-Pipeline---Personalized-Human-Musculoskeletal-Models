...
fprintf('============================================================\n');
fprintf('NMSM JMP RUNNER  v6  TVC04 Walk_3  (v5 full body - stroke config, 8 steps, redistributed budget)\n');
fprintf('Started: %s\n', datestr(now));
fprintf('============================================================\n');
...
fprintf('Next: run TVC04_3_Step2_STO_PLOTS.m\n');
